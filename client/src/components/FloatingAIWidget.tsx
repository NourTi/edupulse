...
export function FloatingAIWidget() {
  ...
  return <>
    ...
    {open && <section id="floating-agent-panel" className="fixed inset-x-3 bottom-24 z-50 flex max-h-[min(680px,calc(100vh-7rem))] flex-col overflow-hidden rounded-[1.35rem] border border-cyan-100/20 bg-[#06283a]/95 text-white shadow-[0_24px_90px_rgba(0,0,0,0.42)] backdrop-blur-2xl sm:inset-x-auto sm:bottom-28 sm:right-7 sm:w-[min(410px,calc(100vw-2rem))]" dir="rtl" role="dialog" aria-modal="false" aria-labelledby="floating-agent-title">
