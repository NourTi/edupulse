  ...
  return <div className="mx-auto max-w-6xl" dir="rtl">
    ...
    <div className="grid gap-5 xl:grid-cols-[1fr_300px]">
      ...
      <aside className="space-y-4">
        ...
        <article className="border border-amber-100/15 bg-amber-100/[0.04] p-5"><p className="text-sm text-amber-50">لأسئلة حسابك</p><p className="mt-2 text-sm leading-7 text-white/55">لا يجيب هذا المساعد عن الدرجات أو الحضور الفردي أو الرسوم الخاصة بك. استخدم بوابة ولي الأمر أو تواصل مع الإدارة.</p></article>
      </aside>
    </div>
  </div>;
}
